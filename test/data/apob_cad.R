...
id_instruments <- "ebi-a-GCST90092810"
id_outcome <- "ieu-a-7"
...
apob_cad <- dat_orig
save(apob_cad, file = "/Users/Sergio/dev/BayesMRclus/data/apob_cad.rda")
...
# mrclust_res <- mrclust_results(apob_cad)
# mrclust_res$p1
# mrclust_res$tab
