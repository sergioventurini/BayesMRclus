...
# id_instruments <- "ieu-a-110"
id_instruments <- "ebi-a-GCST90025996"
id_outcome <- "ebi-a-GCST005185"
...
bmi_insulin <- dat_orig
save(bmi_insulin, file = "/Users/Sergio/dev/BayesMRclus/data/bmi_insulin.rda")
...
mrclust_res <- mrclust_results(bmi_insulin)
mrclust_res$p1
mrclust_res$tab
