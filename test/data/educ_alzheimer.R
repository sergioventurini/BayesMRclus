...
id_instruments <- "ieu-a-1239"
id_outcome <- "ebi-a-GCST90027158"
...
educ_alzheimer <- dat_orig
save(educ_alzheimer, file = "/Users/Sergio/dev/BayesMRclus/data/educ_alzheimer.rda")
