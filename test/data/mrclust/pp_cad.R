...
data("PP_CAD", package = "mrclust")
pp_cad <- PP_CAD[, 2:6]
colnames(pp_cad) <- c("SNP", "beta.exposure", "se.exposure", "beta.outcome", "se.outcome")
save(pp_cad, file = "/Users/Sergio/dev/BayesMRclus/data/pp_cad.rda")
