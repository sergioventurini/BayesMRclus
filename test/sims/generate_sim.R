...
dat_sc1 <- new("bayesmr_data", data = dat, reorientation = TRUE)
# summary(dat_sc1)
...
dat_sc2 <- new("bayesmr_data", data = dat, reorientation = TRUE)
# summary(dat_sc2)
...
dat_sc3 <- new("bayesmr_data", data = dat, reorientation = TRUE)
# summary(dat_sc3)
...
dat_sc4 <- new("bayesmr_data", data = dat, reorientation = F)
# summary(dat_sc4)
